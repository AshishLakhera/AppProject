...
// this.empChage.emit(this.params.node.data);
 ...
 console.log(this.params.node.componentParent);
 this.params.api.deleteEmp(this.params.node.data);
 // this.params.context.componentParent.deleteEmp(this.params.node.data);
